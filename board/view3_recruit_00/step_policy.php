...
<div class="cont_top">
    <div class="inner">
        <h3 class="cont_tit"><em>지원서 작성</em></h3>
        <p class="cont_txt">성묵의 모든 구성원이 반듯한 마인드를 바탕으로 글로벌 시장을 이끌어 갈 창조적 인재를 찾고 있습니다.</p>
    </div>
</div>
    ...
    <div class="inner">
        <div class="apply_agreements">
            <div class="layer layer1">
                ...
                <div class="text_cont">
                    <p class="text">
                        본 채용홈페이지를 통해 제출하는 지원서는 귀하께서 지원서를 제출하는 (주)성묵(이하 채용회사)이 직접 접수하고 관리하며,향후 지원서 관리책임은 채용회사에 있습니다.<br><br>
