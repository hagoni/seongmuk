...
switch($content) {
	case "0":
		...
		break;
	case "1":
		$policy_title = '이메일무단수집거부';
		break;
	case "2":
		$policy_title = '이용약관';
		break;
	case "3":
		$policy_title = '개인정보수집관련 동의사항';
		break;
}
$date = '년 월 일';
?>
...
switch($content) {
	case "0":
?>
<?=$sitename?>(이하 '회사’라 함)은(는) 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다. 회사는 개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다. 본 방침은 <?=$date?>부터 시행됩니다.<br>
<br>
...
가. 고객상담 : 가맹관련 문의 확인 및 답변을 위한 연락통지, 처리결과 통보 등을 목적으로 개인정보를 처리합니다.<br>
나. 정보제공 : 회사에서 주최하는 프로그램에 대한 정보 제공 등의 목적으로 개인정보를 처리합니다.<br>
다. 개인정보 보유기간 : 5년<br>
<br>
4. 개인정보의 파기<br>
...
<?
	...
	case "1":
?>
<?=$sitename?> 이용자에게 무차별적으로 보내지는 타사의 메일을 차단하기 위해,<br>
...
?>
1. 개인정보의 수집 및 이용 목적<br>
사이트 이용자의 문의 확인 및 답변을 위한 연락통지, 처리결과 통보 등을 목적으로 개인정보를 처리합니다.<br>
<br>
2. 처리하는 개인정보 항목<br>
- 필수항목 : 이름, 연락처 (접속 IP 정보, 쿠키, 서비스 이용 기록, 접속 로그)<br>
- 선택항목 : 이메일<br>
...
?>
	...
	<button type="button" id="bindPolicyModalX" class="btnPolicyX">닫기</button>
</div>