...
<?
    ...
    while($list = mysql_fetch_assoc($out_sql)) {
        ...
        $next_command_01 = cut($list['view3_command_01'], 60);
        ...
        <li>
            <a href="<?=$path_view?>">
                ...
                <div class="board_list_text">
                    <p class="board_list_title b_fs_l b_ff_h b_c_h ellipsis"><?=$option['notice'].$list['view3_title_01']?></p>
                    <p class="board_list_desc b_fs_m b_ff_m b_lh_l b_c_m"><?=$next_command_01?></p>
                    <p class="board_list_date b_fs_m b_ff_l b_c_l"><?=$write_day?></p>
                </div>
            </a>
        </li>
<?
