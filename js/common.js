	...
	window.Policy = function() {
		...
		this.initialize = function() {
			$('.bindPolicyModalOpen').click(function(e) {
				$('.bindPolicyModalOpen').unbind('click');
		...
		this.modalOpen = function(i) {
			var requestUrl = CONST_ROOT + '/policy/policy.php';
			$.post(requestUrl, {content: i, root: CONST_ROOT}, function(response) {
				body.append(response);
...
(function($) {
	$(document).ready(function() {
		new Policy();
		new Sitemap();
		new Swiper('.stm_depth1_li2 .stm_depth2_slide.swiper-container', {
			initialSlide: $('.stm_depth1_li2 li.on').index(),
		    slidesPerView: 'auto',
		    centeredSlides: true,
			spaceBetween: 35,
		    speed: 500,
		...
		new Swiper('.stm_depth1_li4 .stm_depth2_slide.swiper-container', {
			initialSlide: $('.stm_depth1_li4 li.on').index(),
		    slidesPerView: 'auto',
		    centeredSlides: true,
			spaceBetween: 35,
		    speed: 500,
